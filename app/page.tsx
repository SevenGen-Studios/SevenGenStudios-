  ...
  return <main className="cinema-home" ref={track}>
    <div className="cinema-stage">
      ...
      <section className="cinema-scene cinema-second" aria-hidden={active!==1} inert={active!==1} style={{opacity:opacities[1],pointerEvents:active===1?"auto":"none"}}>
        <div className="cinema-scene-copy"><p className="cinema-eyebrow">01 / Our first product</p><h2>Public information.<br/><em>Made useful.</em></h2><p className="cinema-body">We built openband.ca to make Saskatchewan First Nations records and community information easier to find and verify.</p><div className="cinema-proof"><span>openband.ca<small>Research · Design · Development</small></span><Link href="/work" className="cinema-link">Explore the work <span>↗</span></Link></div></div><figure className="cinema-product cinema-arrival" style={{transform:`translateY(${(1-opacities[1])*36}px)`}}><a href="https://openband.ca" target="_blank" rel="noreferrer" aria-label="Visit openband.ca"><img src="/openband-home.svg" alt="Actual openband.ca homepage showing its Saskatchewan First Nations search and public filings" width="1280" height="720" /></a><figcaption><span>openband.ca</span><span>Designed & built by SevenGen ↗</span></figcaption></figure>
      </section>
